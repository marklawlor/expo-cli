...
const hooksMap = new WeakMap<any, Record<string, AsyncSeriesWaterfallHook>>();
...
export default class JsonWebpackPlugin {
  static getHooks(compilation: any): Record<string, AsyncSeriesWaterfallHook> {
  ...
  private writeObject = async (compilation: any, callback: () => void): Promise<void> => {
